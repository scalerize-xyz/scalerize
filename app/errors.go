...
var (
	...
	ErrCannotAppendIfKeyIsLessThanCurrentGreatestKey         = errors.New("cannot append entry when key is less than greatest key in the table")
	ErrCannotAppendDupIfSubkeyIsLessThanGreatestSubKeyForKey = errors.New("cannot append entry when subkey is less than greatest subkey for the key")
)
