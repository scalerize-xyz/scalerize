...
// NewRootCmd creates a new root command for scalerized. It is called once in the
// main function.
func NewRootCmd() *cobra.Command {
	...
	rootCmd := &cobra.Command{
		Use:   "scalerized",
		Short: "scalerized - the ultimate rollup",
		PersistentPreRunE: func(cmd *cobra.Command, _ []string) error {
			...
			srvCfg.MinGasPrices = "0scalerize"
...
func ProvideClientContext(
	...
	clientCtx := client.Context{}.
		...
		WithViper("SCALERIZE") // env variable prefix
